...
exports.OrderModule = OrderModule = __decorate([
    (0, common_1.Module)({
        imports: [
            sequelize_1.SequelizeModule.forFeature([order_schema_1.Orders, auth_schema_1.Admin, activity_log_schema_1.ActivityLog]),
        ],
        providers: [order_service_1.OrderService, activity_log_service_1.ActivityLogService, activityLogger_1.ActivityLogger],
